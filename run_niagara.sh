...
#rm -rf *.txt
echo " ->  $MKLROOT"
cmake -DCMAKE_PREFIX_PATH="$MKLROOT/lib/intel64;$MKLROOT/include;$MKLROOT/../compiler/lib/intel64;_deps/openblas-build/lib/;/home/m/mmehride/kazem/programs/metis-5.1.0/libmetis;/home/m/mmehride/kazem/programs/metis-5.1.0/include/;" -DMKL_DIR=$MKLROOT -DMKL_ROOT_PATH=$MKLROOT  -DCMAKE_BUILD_TYPE=Release ..
#make -j 40
make sparse_mkl_test
...
echo "Config,N,M,NNZ,MV (sec),MV Inspection (sec),SV (sec),Inspection (sec),Matrix Name,Method,Seq SV (sec),Cores,Test," > logs/sparse_mkl.csv
